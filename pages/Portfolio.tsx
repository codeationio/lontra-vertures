...
const Security = [
  ...
  { logo: [{ href: 'https://protopia.ai/', url: '/images/Protopia-1024x512_tcm19-61758.avif', width: 400 }] },
...
const Software = [
  ...
  { logo: [{ href: 'https://www.reactivesearch.io/', url: '/images/reactive-search-logo.png', width: 250 }] },
...
const Emerging = [
  {
    ...
    logo: [{ href: 'https://www.contoro.com/', url: '/images/cropped-cropped-cropped-11-1-300x82.png', width: 150 }],
  },
  ...
  { logo: [{ href: 'https://join5x5.com/', url: '/images/five_five-logo.png', width: 120 }] },
...
const Healthcare = [
  ...
  { logo: [{ href: 'https://frontrow.co.in/', url: '/images/frontrow-logo.png', width: 200 }] },
...
const Exits = [
  ...
  {
    logo: [
      { href: 'https://www.mediafly.com/', url: '/images/olono_logo.png', width: 170 },
      { href: 'https://www.mediafly.com/', url: '/images/MediaFly-logo.jpeg', width: 200 },
    ],
  },
];
