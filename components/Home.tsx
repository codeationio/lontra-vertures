        ...
        <div className="md:grid">
          <div className="flex flex-row items-start ">
            <figure className="webImage">
              <Image alt="lontra-ventures-logo" height={70} src="/images/lontra-ventures-logo.png" width={70} />
            </figure>
            <figure className="md:hidden">
              <Image alt="lontra-ventures-logo" height={50} src="/images/lontra-ventures-logo.png" width={50} />
            </figure>
            <div className="ml-5">
              <h1 className="font-serif text-xl font-light md:text-4xl  ">Lontra Ventures</h1>
          ...
          <div className="mt-20 flex flex-col justify-end md:m-0 md:items-baseline ">
            <h1 className="mb-5 text-2xl text-[#ED5829] md:text-4xl ">Our Approach</h1>
            <p className="text-lg font-light text-[#333333] md:text-xl ">
