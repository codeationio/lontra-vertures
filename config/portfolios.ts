...
export const Software: Company[] = [
  ...
  },
  {
    logo: [
      {
        href: 'https://getsift.ai/',
        url: '/images/siftai_logo.jpg',
        width: 200,
      },
    ],
    name: 'Sift',
...
export const Emerging: Company[] = [
  {
    logo: [
      {
        href: 'https://www.allencontrolsystems.com/',
        url: '/images/allen_control_systems_logo.jpg',
        width: 150,
      },
    ],
...
export const Healthcare: Company[] = [
  {
    logo: [
      {
